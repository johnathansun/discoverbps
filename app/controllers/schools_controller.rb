    ...
    def csv_row(schools, csv)
      ...
      schools.each do |student_school|
        ...
        csv << [ '',
          ...
          programs_list_helper(school.api_programs).try(:join, ', '),
          facilities_list_helper(school.api_facilities).try(:join, ', '),
          student_support_list_helper(school.api_student_support).try(:join, ', '),
          partners_list_helper(school.api_partners).try(:join, ', '),
          sports_list_helper(school.api_sports).try(:join, ', '),
